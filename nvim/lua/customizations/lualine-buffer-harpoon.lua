...
local harpoon = require("customizations.harpoon-utils")
...
function Buffer:render()
	...
	-- apply
	if harpoon:buf_is_harpooned(self.bufnr) then
		local harpoon_id = harpoon:get_harpoon_index(self.bufnr)
		line = " " .. harpoon_id .. line
	end
